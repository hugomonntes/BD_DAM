...
--20
SELECT IDDEPART, COUNT(*) FROM empleados WHERE OFICIO = (SELECT OFICIO FROM depart WHERE OFICIO = "Empleado" LIMIT 1) GROUP BY IDDEPART;
--21
...
--24
SELECT IDDEPART, COUNT(*) FROM empleados WHERE IDDEPART = (SELECT IDDEPART FROM depart WHERE NOMBRE = 'VENTAS') AND OFICIO = "VENDEDOR";
--25
SELECT APELLIDO, COMISION FROM EMPLEADOS WHERE COMISION > (SELECT COMISION FROM EMPLEADOS WHERE CODEMP = 3);
--26
SELECT COUNT(*) FROM empleados WHERE IDDEPART = (SELECT IDDEPART FROM depart WHERE NOMBRE = 'VENTAS') AND OFICIO = 'DIRECTOR';
--27
SELECT MIN(SALARIO), IDDEPART FROM empleados WHERE IDDEPART != (SELECT IDDEPART FROM depart WHERE LOC = 'MADRID') GROUP BY IDDEPART;
--28
SELECT APELLIDO, IDDEPART FROM empleados WHERE IDDEPART = (SELECT IDDEPART FROM depart WHERE LOC = 'Madrid') OR IDDEPART = (SELECT IDDEPART FROM depart WHERE LOC = 'Barcelona') ORDER BY IDDEPART; -- Forma sin IN

SELECT APELLIDO, IDDEPART FROM empleados WHERE IDDEPART IN (SELECT IDDEPART FROM depart WHERE LOC = 'Madrid' OR LOC = 'Barcelona') ORDER BY IDDEPART;
--29
SELECT IDDEPART, NOMBRE FROM depart GROUP BY IDDEPART HAVING IDDEPART NOT IN (SELECT IDDEPART FROM empleados WHERE COUNT(*) != 0);
--30
SELECT APELLIDO, OFICIO, COMISION FROM empleados WHERE IDDEPART NOT IN (SELECT IDDEPART FROM depart WHERE LOC LIKE 'Madrid' OR LOC LIKE 'Sevilla') AND APELLIDO IN (SELECT APELLIDO FROM empleados WHERE COMISION IS NULL);
--31 // FIXME
SELECT APELLIDO, OFICIO FROM empleados WHERE IDDEPART = (SELECT IDDEPART FROM empelados WHERE OFICIO = (SELECT OFICIO FROM depart WHERE NOMBRE = "VENTAS"));
--32
SELECT NOMBRE FROM asignaturas WHERE COD IN (SELECT ASIGNATURA FROM notas WHERE NOTA >= 5);
--33
SELECT MAX(SALARIO), OFICIO FROM empleados GROUP BY IDDEPART HAVING IDDEPART IN (SELECT IDDEPART FROM depart WHERE LOC LIKE "MADRID" OR LOC LIKE "SEVILLA") AND AVG(SALARIO) < 4000;
--34
SELECT IDDEPART, NOMBRE FROM depart WHERE IDDEPART IN (SELECT IDDEPART FROM empleados GROUP BY IDDEPART HAVING COUNT(*) > (SELECT COUNT(*) FROM empleados WHERE IDDEPART = 20));